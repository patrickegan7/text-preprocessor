class ContractionExpander:
    ...
    def remove_contraction(self, contraction):
        return self.contractions.pop(contraction, None)


    # Created to have dictionary at the end of the file
    def __create_contractions(self):
        # dictionary taken from Neal Shyam's post at https://devpost.com/software/contraction-expander
        return {
          "ain't": "am not",
          "aren't": "are not",
          "can't": "cannot",
